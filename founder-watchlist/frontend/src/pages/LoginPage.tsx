  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-slate-100 p-4">
      <form onSubmit={submit} className="w-full max-w-md rounded border border-slate-200 bg-white p-8 shadow-sm">
        <h1 className="text-2xl font-semibold text-slate-950">Founder Watchlist</h1>
        <p className="mt-1 text-sm text-slate-600">Track people before they become formal deals.</p>
        ...
        <button className="mt-6 w-full rounded bg-slate-900 px-4 py-2 font-medium text-white">Log in</button>
        <p className="mt-4 text-sm text-slate-600">Need an account? <Link to="/register" className="font-medium text-slate-950 underline">Register</Link></p>
      </form>
    </div>
  );
}
